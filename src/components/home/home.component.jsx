...
const Home = () => {
    return (
        <div className="home">
            <h3 className="header-text">Hello, welcome to my page! <span className="wave-emoji emoji">&#128075;</span></h3>
            ...
            <section className="myself">
                <div className="description">
                    <p className="me">This is me <span className="point-emoji emoji">&#128073;</span></p>
                </div>
                <div className="image">
